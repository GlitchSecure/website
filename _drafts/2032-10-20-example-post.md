---
layout: post
# The filename will be used for URL slug generation, so keep it to 1-4 words.
title: "I'm an example post"
# Keep the title short, does not need to match the filename exactly
...
image:
  ...
  # Include photo authors name
  creditlink: https://www.pexels.com/photo/green-and-white-lights-5473951/
  # Include link to original photo
hero-vertical: true
# Whether to use a vertical layout. Default is true.
hero-wrapper-padding: "pb-24"
# This must be set to "pb-24" when using a vertical layout.
comments: true
