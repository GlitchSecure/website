...
You provide data when you view and enter into a contract with us, communicate with us for customer support reasons, use our products or services, or create a user account on our website.
...
You have choices when it comes to the data you share. If you have an account on our website, you can request that we delete any personal data we hold about you by sending a request to hello@glitchsecure.com, and GlitchSecure will delete such data within a reasonable time. This does not include any data we are obliged to keep for administrative, legal, or security purposes.

When we ask you to provide personal data or information, you can decline to do so. If this information is necessary to provide you with a service, we are unable to provide that service to you. Additionally, if we are required to collect this information according to law, or in order to enter into or carry out a contract with you, we will not be able to do so, and you must immediately discontinue use of our website and services.
...
In case of any data breach of user information, website database, or third-party data, we will inform you of such breach without any undue delay.
